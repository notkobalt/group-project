...
#list for all characters i want to display
...
class Characters:
    ...
    #defining my character series and setting the self series
    ...
    #fibonacci data; instance variables for the class.
